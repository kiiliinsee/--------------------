        ...
        <div class="col-xs-12">
                ...
                <div class="sln-booking-services-alerts">
                    <span id="sln-alert-noservices"
                      class="sln-alert sln-alert--warning sln-alert--inline <?php echo $bookingServices ? 'hide' : '' ?>"><?php echo __('No services addded yet', 'salon-booking-system') ?></span>
                    <span id="sln-alert-no-duration"
                          class="sln-alert sln-alert--error sln-alert--inline hide"><?php echo __('This service has no duration, change it or add another one!', 'salon-booking-system') ?></span>
                    <span id="sln-alert-duration-exceeded"
                          class="sln-alert sln-alert--error sln-alert--inline hide"><?php echo __('Total services duration exceeded, change or remove one!', 'salon-booking-system') ?></span>
                </div>
        </div>
        ...
        <div class="col-xs-12 sln-booking-service-line">
            ...
            <?php if ('highend' == $plugin->getSettings()->getAvailabilityMode()): ?>
                <div class="sln-booking-service--startend">
                    <div>
                        <h5 class="sln-booking-service-line__label"><?php _e('Start at', 'salon-booking-system')?></h5>
                        <label class="time"></label>
                    </div>
                    <div>
                        <h5 class="sln-booking-service-line__label"><?php _e('End at', 'salon-booking-system')?></h5>
                        <label class="time"></label>
                    </div>
                </div>
            <?php endif;?>
                <div class="sln-booking-service--itemselection sln-select">
                <h5 class="sln-booking-service-line__label"><?php _e('Service', 'salon-booking-system')?></h5>
...
?>
            ...
            <?php if ($isResourcesEnabled): ?>
                <div class="sln-booking-service--resources sln-select">
                    <h5 class="sln-booking-service-line__label"><?php _e('Resource', 'salon-booking-system')?></h5>
                    <p class="sln-no-resources hide"><?php _e('No resources', 'salon-booking-system') ?></p>
                    <?php SLN_Form::fieldSelect(
            ...
            <div class="sln-booking-service--attendants sln-select">
                <h5 class="sln-booking-service-line__label"><?php _e('Attendant', 'salon-booking-system')?></h5>
	...
	true
            ...
            <div class="sln-booking-service--action">
                <span class="sln-alert sln-alert--fadeinout sln-alert--ok sln-alert--onremove hide"><?php echo __('Service addded', 'salon-booking-system') ?></span>
                    <button type="button" class="sln-btn sln-btn--big sln-btn--icon sln-btn--icon--left--alt sln-icon--times sln-btn--textonly sln-btn--textonly--emph" data-collection="remove"><?php echo __('Remove', 'salon-booking-system') ?></button>
            </div>
        </div>
    </div>
        <?php
...
<?php endforeach?>
        ...
        <script>
            ...
            var resourcesData = '<?php echo addslashes(json_encode($resourcesData)); ?>';
        </script>
