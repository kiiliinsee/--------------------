...
<div class="row">
    ...
    <?php if($settings->get('attendant_enabled') === '1') : ?>
        <div class="col-xs-12 col-md-8 form-group sln-select">
            <label><?php echo __('Limit this discount to the assistants', 'salon-booking-system') ?></label>
            <?php
            ...
            <p><?php _e('Leave it blank if you want to be applied to all assistants','salon-booking-system'); ?></p>
        </div>
    <?php endif;?>
    <?php if($isShopEnabled) : ?>
        <div class="col-xs-12 col-md-8 form-group sln-select">
            <label><?php echo __('Limit this discount to the following shops', 'salon-booking-system') ?></label>
            <?php
            /** @var SLN_Wrapper_Attendant[] $attendants */
            ...
            <p><?php _e('Leave it blank if you want to be applied to all shops','salon-booking-system'); ?></p>
        </div>
    <?php endif;?>
