                    ...
                    <b-row>
                        <b-col sm="12">
                            <div class="customer-email">
                                <b-form-input :placeholder="$t('customerEmailPlaceholder')" v-model="elCustomerEmail" @blur="loadDiscounts"/>
                            </div>
                        </b-col>
                    </b-row>
                    <b-row>
                        ...
                        <b-row class="field">
                            <b-col sm="12">
                                <div class="customer-personal-notes">
                                    <label class="label" for="customer_personal_notes">{{ $t('customerPersonalNotesLabel') }}</label>
                                    <b-form-textarea
                                        v-model.lazy="elCustomerPersonalNotes"
                                        id="customer_personal_notes"
                                        :placeholder="$t('customerPersonalNotesPlaceholder')"
                                        rows="3"
                                        max-rows="6"
                                    ></b-form-textarea>
                                </div>
                            ...
                            <div class="resource">
                                <vue-select ref="select-resource" class="service-select" close-on-select v-model="service.resource_id"  :options="getAttendantsOrResourcesListBySearch(resourcesList, resourceSearch[index])" label-by="text" value-by="value" :class="{required: requiredFields.indexOf('services_assistant_' + index) > -1}" @focus="loadAvailabilityResources(service.service_id)">
                                    <template #label="{ selected }">
                                        ...
                                        <template v-else>{{ $t('selectResourcesPlaceholder') }}</template>
                                    </template>
                                    <template #dropdown-item="{ option }">
                                        <div class="option-item">
                                            <div class="availability-wrapper">
                                ...
                                <li class="vue-select-search">
                                    <font-awesome-icon icon="fa-solid fa-magnifying-glass" class="vue-select-search-icon" />
                                    <b-form-input v-model="resourceSearch[index]" class="vue-select-search-input" :placeholder="$t('selectResourcesSearchPlaceholder')" @mousedown.stop></b-form-input>
                                </li>
                            </div>
                        </b-col>
                                ...
                                <div class="discount">
                                    <vue-select ref="select-discount" class="discount-select" close-on-select
                                        ...
                                        <template #label="{ selected }">
                                            ...
                                            <template v-else>{{ $t('selectDiscountLabel') }}</template>
                                        </template>
                                        <template #dropdown-item="{ option }">
                                            <div class="option-item">
                                    ...
                                    <li class="vue-select-search">
                                        ...
                                        <b-form-input v-model="discountSearch[index]" class="vue-select-search-input"
                                                      :placeholder="$t('selectDiscountsSearchPlaceholder')"
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                vueTelInputOptions: {
                    'placeholder': this.$t('customerPhonePlaceholder')
                }
            };
        },
        watch: {
