    ...
    public function manage_column($column, $post_id)
    {
        ...
        switch ($column) {
            ...
            case 'myauthor':
                ...
                if($obj->getPhone()){
                    echo '<div><a href="https://wa.me/'. esc_url($obj->getSmsPrefix() . $obj->getPhone()) .'">Tel. '. esc_html($obj->getSmsPrefix() . $obj->getPhone()) .'</a></div>';
                }
                break;
            case 'booking_status' :
                ...
                case 'booking_actions' :
                    if ( $this->getPlugin()->getSettings()->get('confirmation') && $obj->getStatus(
                        ...
                        echo '<div class="sln-booking-confirmation '. ( !defined("SLN_VERSION_PAY") ? 'sln-booking-confirmation-disabled' : '') .'">';
                            ...
                            echo '<div class="sln-booking-confirmation-success" data-status="' . SLN_Enum_BookingStatus::CONFIRMED . '" data-booking-id="' . $obj->getId() . '" title="' . ( esc_attr($title) ? '' : __('Accept', 'salon-booking-system') ) . '" data-class="success"></div>';
                            echo '<div class="sln-booking-confirmation-error" data-status="' . SLN_Enum_BookingStatus::CANCELED . '" data-booking-id="' . $obj->getId() . '" title="' . ( esc_attr($title) ? '' : __('Refuse', 'salon-booking-system') ) . '" data-class="danger"></div>';
                        echo '</div>';
				    }
