    ...
    'bookings' => array(
        ...
        array(
            ...
            'meta' => array(
                ...
                '_sln_booking_duration' => '00:00',
                '_sln_calendar_attendants_event_id' => array(),
                '_edit_last' => '1',
                '_sln_booking_amount' => 15,
                '_sln_booking_date' => (new DateTime())->format('Y-m-d'),
                '_sln_booking_time' => (new DateTime())->format('H:i'),
                '_sln_booking_firstname' => 'Customer firstname',
                '_sln_booking_lastname' => 'Customer lastname',
                '_sln_booking_email' => 'custome@mail.com',
                '_sln_booking_phone' => '8888888888888888',
            )
        ),
        array(
            'post' => array(
