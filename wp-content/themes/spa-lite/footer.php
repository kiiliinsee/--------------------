        ...
        <?php } ?>
         <div class="copyright-wrapper">
        	<div class="container">
            	 ...
            	 <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','spa-lite');?><?php if( is_home() && is_front_page()) {?>
        <a href="<?php echo esc_url('https://www.sktthemes.org/');?>" target="_blank"><?php esc_html_e('SKT Themes','spa-lite'); ?></a>
        <?php } else {?>
          <?php esc_html_e('SKT Themes','spa-lite'); ?>
        <?php } ?></div>
                 <div class="clear"></div>
            </div>           
        </div>
